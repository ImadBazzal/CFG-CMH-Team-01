    ...
    <>
      <section className="relative z-10 w-full max-w-3xl mx-auto rounded-[32px] border border-white/10 bg-gradient-to-br from-[#070916]/90 to-[#070b20]/70 p-6 sm:p-8 lg:p-10 shadow-panel backdrop-blur-3xl">
        ...
        >
          ...
          <button
            className="rounded-full bg-gradient-to-r from-[#6f7dff] to-[#5ecfff] px-12 py-3 text-base font-semibold text-[#020308] shadow-[0_12px_25px_rgba(94,207,255,0.25)] transition hover:-translate-y-0.5 hover:shadow-[0_18px_35px_rgba(94,207,255,0.35)] disabled:translate-y-0 disabled:cursor-not-allowed disabled:opacity-70"
            type="submit"
          >
            Search
          </button>
        ...
        {errorMessage && <p className="mt-4 font-semibold text-red-400 text-center">{errorMessage}</p>}
      </section>
    </>
  )
}
